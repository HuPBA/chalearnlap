...
def home(request):
	...
	return render(request, "home.html", {"news": news, "chalearn": chalearn})
...
def home_edit(request):
	...
	return render(request, "home-edit.html", {"chalearn": chalearn, "form": form})
...
def help_edit(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			help.save()
			return HttpResponseRedirect(reverse('home'))
	return render(request, "help-edit.html", {"help": help, "form": form})
...
def cimlbook_creation(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			return HttpResponseRedirect(reverse('home'))
	return render(request, "cimlbook-edit.html", {"form": form})
...
def main_organizers(request):
	...
	return render(request, "main-organizers.html", {"profiles": profiles})
...
def export_user_csv(request):
	...
	for u in users:
		...
		if u.user:
			if u.newsletter:
				writer.writerow([u.pk,str(u.user.username),str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.user.email).encode('utf-8'),(u.affiliation),'yes'.encode('utf-8'),events])
			else:
				writer.writerow([u.pk,str(u.user.username),str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.user.email).encode('utf-8'),(u.affiliation),'no'.encode('utf-8'),events])
		else: 
			if u.newsletter:
				writer.writerow([u.pk,'',str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.email).encode('utf-8'),(u.affiliation),'yes'.encode('utf-8'),events])
			else:
				writer.writerow([u.pk,'',str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.email).encode('utf-8'),(u.affiliation),'no'.encode('utf-8'),events])
	return response
...
def export_members_csv(request, event_id=None):
	...
	for u in profile_events:
		...
		u = u.profile
		if u.user:
			writer.writerow([u.pk,str(u.user.username),str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.user.email).encode('utf-8'),(u.affiliation),str(role_name).encode('utf-8')])
		else: 
			writer.writerow([u.pk,'',str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.email).encode('utf-8'),(u.affiliation),str(role_name).encode('utf-8')])
	return response
...
def export_participants_csv(request, dataset_id=None, grid_id=None):
	...
	for u in submissions:
		...
		writer.writerow([u.pk,str(u.user.username),str(u.first_name).encode('utf-8'),str(u.last_name).encode('utf-8'),str(u.user.email).encode('utf-8'),(u.affiliation)])
	return response
...
def profile_select(request, id=None):
	...
	return render(request, "profile/select.html", context)
...
def dataset_profile_select(request, dataset_id=None):
	...
	return render(request, "dataset/select.html", context)
...
def dataset_creation(request):
	...
	if request.method == 'POST':
		datasetform = DatasetCreationForm(request.POST, request.FILES)
...
def dataset_edit_desc(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/desc.html", context)
...
def dataset_edit_schedule(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/desc.html", context)
	else:
		schedule = Schedule_Event.objects.filter(dataset_schedule=dataset).order_by('date')
		context = {
			"dataset": dataset,
		...
		return render(request, "dataset/edit/schedule.html", context)
...
def dataset_edit_relations(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/relations.html", context)
...
def dataset_edit_datas(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/datas.html", context)
...
def dataset_edit_members(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/members.html", context)
...
def dataset_edit_results(request, id=None, grid_id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/results.html", context)
...
def dataset_edit_news(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/news.html", context)
...
def dataset_edit_publications(request, id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/publications.html", context)
...
def dataset_edit_col(request, id=None, col_id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/col.html", context)
...
def dataset_edit_submission(request, id=None, submission_id=None):
	...
	if check_edit_dataset_permission(request, dataset) == False:
		...
		return render(request, "dataset/edit/result_user_submission.html", context)
...
def dataset_schedule(request, id=None):
	...
	return render(request, "dataset/schedule.html", context)
...
def dataset_associated_events(request, dataset_id=None):
	...
	return render(request, "dataset/relations.html", context)
...
def dataset_publications(request, id=None):
	...
	return render(request, "dataset/publications.html", context)
...
def data_edit_desc(request, id=None, dataset_id=None):
	...
	return render(request, "data/edit/desc.html", context)
...
def data_edit_files(request, id=None, dataset_id=None):
	...
	return render(request, "data/edit/files.html", context)
...
def file_creation(request, id=None, dataset_id=None):
	...
	return render(request, "file/creation.html", context)
...
def data_desc(request, id=None, dataset_id=None):
	...
	return render(request, "data/desc.html", context)
...
def data_software(request, id=None, dataset_id=None):
	...
	return render(request, "data/software.html", context)
...
def data_metric(request, id=None, dataset_id=None):
	...
	return render(request, "data/metrics.html", context)
...
def data_files(request, id=None, dataset_id=None):
	...
	return render(request, "data/files.html", context)
...
def dataset_results(request, dataset_id=None, grid_id=None):
	...
	return render(request, "dataset/results.html", context)
...
def partner_creation(request, id=None):
	...
	return render(request, "partner/creation.html", context)
...
def partner_select(request, id=None):
	...
	return render(request, "partner/select.html", context)
...
def event_proposal_creation(request):
	...
	return render(request, "proposal/creation.html", context)
...
def challenge_edit_desc(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/desc.html", context)
...
def challenge_edit_schedule(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/schedule.html", context)
...
def challenge_edit_relation(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/relation.html", context)
...
def challenge_edit_result(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/result.html", context)
...
def challenge_edit_members(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/members.html", context)
...
def challenge_edit_sponsors(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/sponsors.html", context)
...
def challenge_edit_tracks(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/tracks.html", context)
...
def challenge_edit_news(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/news.html", context)
...
def challenge_edit_publications(request, id=None):
	...
	if check_edit_event_permission(request, challenge) == False:
		...
		return render(request, "challenge/edit/publications.html", context)
...
def result_edit(request, id=None, track_id=None, result_id=None):
	...
	return render(request, "track/edit/result_user.html", context)
...
def fact_sheet_creation(request, id=None, track_id=None, result_id=None, sheet_id=None):
	...
	return render(request, "track/edit/result_user_creation.html", context)

@login_required(login_url='auth_login')
def result_user_submission(request, dataset_id=None, sub_id=None):
	dataset = Dataset.objects.filter(id=dataset_id).first()
...
@login_required(login_url='auth_login')
def result_user_submission_edit(request, dataset_id=None, sub_id=None, sheet_id=None):
	dataset = Dataset.objects.filter(id=dataset_id).first()
	submission = Submission.objects.filter(id=sub_id).first()
	if sheet_id==None:
		factsheetform = ResultUserForm()
		if request.method == 'POST':
			...
			if factsheetform.is_valid():
				...
				content = factsheetform.cleaned_data['content']
				paper = factsheetform.cleaned_data['paper']
				r_user = Result_User.objects.create(name=name, content=content, submission=submission)
				r_user.paper = paper
				r_user.save()
				return HttpResponseRedirect(reverse('submission_resume', kwargs={'dataset_id':dataset_id, 'sub_id':sub_id}))
	else:
		result_user = Result_User.objects.filter(id=sheet_id).first()
		factsheetform = ResultUserForm(result_user=result_user)
		if request.method == 'POST':
	...
	return render(request, "dataset/edit/result_user_submission_edit.html", context)
...
def header_edit(request, id=None, track_id=None, header_id=None):
	...
	return render(request, "track/edit/header.html", context)
...
def result_new_table(request, id=None, track_id=None):
	...
	return render(request, "track/edit/new_table.html", context)
...
def result_new_row(request, id=None, track_id=None):
	...
	return render(request, "track/edit/new_row.html", context)
...
def challenge_associated_events(request, id=None):
	...
	return render(request, "challenge/relations.html", context)
...
def event_relation_creation(request, id=None, dataset_id=None):
	...
	return render(request, "relations/creation.html", context)
...
def track_desc(request, id=None,track_id=None):
	...
	return render(request, "track/desc.html", context)
...
def track_metrics(request, id=None,track_id=None):
	...
	return render(request, "track/metrics.html", context)
...
def track_baseline(request, id=None,track_id=None):
	...
	return render(request, "track/baseline.html", context)
...
def track_result(request, id=None, track_id=None):
	...
	return render(request, "track/result.html", context)
...
def result_fact_sheet(request, id=None, dataset_id=None, track_id=None, f_sheet_id=None):
	if dataset_id==None:
		...
		return render(request, "track/fact_sheet.html", context)
	else:
		dataset = Dataset.objects.filter(id=dataset_id).first()
		grids = Result_Grid.objects.filter(track__dataset=dataset)
		news = News.objects.filter(dataset=dataset)
		...
		return render(request, "dataset/fact_sheet.html", context)
...
def track_creation(request, id=None):
	...
	return render(request, "track/creation.html", context)
...
def track_edit_desc(request, id=None, track_id=None):
	...
	if check_edit_event_permission(request, c) == False:
		...
		return render(request, "track/edit/desc.html", context)
...
def track_edit_result(request, id=None, track_id=None):
	...
	if check_edit_event_permission(request, c) == False:
		...
		return render(request, "track/edit/result.html", context)
...
def challenge_members(request, id=None, role_id=None):
	...
	return render(request, "challenge/members.html", context)
...
def challenge_sponsors(request, id=None):
	...
	return render(request, "challenge/sponsors.html", context)
...
def challenge_schedule(request, id=None):
	...
	return render(request, "challenge/schedule.html", context)
...
def challenge_publications(request, id=None):
	...
	return render(request, "challenge/publications.html", context)
...
def workshop_edit_desc(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/desc.html", context)
	else:
		eventform = EditEventForm(event=workshop)
		if request.method == 'POST':
			eventform = EditEventForm(request.POST, event=workshop)
		...
		return render(request, "workshop/edit/desc.html", context)
...
def workshop_edit_schedule(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/schedule.html", context)
...
def workshop_edit_relations(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/relations.html", context)
...
def workshop_edit_program(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/program.html", context)
...
def workshop_edit_members(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/members.html", context)
...
def workshop_edit_gallery(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/gallery.html", context)
...
def workshop_edit_news(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/news.html", context)
...
def workshop_edit_publications(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/publications.html", context)
...
def workshop_edit_sponsors(request, id=None):
	...
	if check_edit_event_permission(request, workshop) == False:
		...
		return render(request, "workshop/edit/sponsors.html", context)
...
def workshop_schedule(request, id=None):
	...
	return render(request, "workshop/schedule.html", context)
...
def workshop_associated_events(request, id=None):
	...
	return render(request, "workshop/relation.html", context)
...
def workshop_program(request, id=None):
	...
	return render(request, "workshop/program.html", context)
...
def workshop_members(request, id=None, role_id=None):
	...
	return render(request, "workshop/members.html", context)
...
def workshop_publications(request, id=None):
	...
	return render(request, "workshop/publications.html", context)
...
def workshop_sponsors(request, id=None):
	...
	return render(request, "workshop/sponsors.html", context)
...
def add_gallery_picture(request, id=None):
	...
	return render(request, "workshop/add_picture.html", context)
...
def edit_gallery_picture(request, id=None, pic_id=None):
	...
	return render(request, "workshop/edit_picture.html", context)
...
def speaker_select(request, id=None):
	...
	return render(request, "speaker/select.html", context)
...
def speaker_creation(request, id=None):
	...
	return render(request, "speaker/creation.html", context)
...
def special_issue_edit_desc(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/desc.html", context)
	else:
		eventform = EditEventForm(event=issue)
		if request.method == 'POST':
			eventform = EditEventForm(request.POST, event=issue)
		...
		return render(request, "special_issue/edit/desc.html", context)
...
def special_issue_edit_relations(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/edit/relations.html", context)
...
def special_issue_edit_members(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/edit/members.html", context)
...
def special_issue_edit_schedule(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/edit/schedule.html", context)
...
def special_issue_edit_news(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/edit/news.html", context)
...
def special_issue_edit_publications(request, id=None):
	...
	if check_edit_event_permission(request, issue) == False:
		...
		return render(request, "special_issue/edit/publications.html", context)
...
def special_issue_members(request, id=None, role_id=None):
	...
	return render(request, "special_issue/members.html", context)
...
def special_issue_schedule(request, id=None):
	...
	return render(request, "special_issue/schedule.html", context)
...
def special_issue_associated_events(request, id=None):
	...
	return render(request, "special_issue/relations.html", context)
...
def special_issue_publications(request, id=None):
	...
	return render(request, "special_issue/publications.html", context)
...
def role_creation(request):
	...
	return render(request, "role/creation.html", context)
...
def news_creation(request, id=None, dataset_id=None):
	...
	return render(request, "news/creation.html", context)
...
def schedule_creation(request, dataset_id=None, id=None):
	...
	return render(request, "program/creation.html", context)
...
def subevent_creation(request, event_id=None, program_id=None):
	...
	return render(request, "program/creation-subevent.html", context)
...
def submission_creation(request, dataset_id=None, grid_id=None):
	...
	return render(request, "dataset/submission.html", context)
...
def submission_score(request, dataset_id=None, sub_id=None):
	...
	return render(request, "dataset/score.html", context)

@login_required(login_url='auth_login')
def submission_instructions_edit(request, dataset_id=None, grid_id=None):
	result_grid = Result_Grid.objects.filter(id=grid_id).first()
	form = SubmissionInstructionsForm(result_grid=result_grid)
	if request.method == 'POST':
		form = SubmissionInstructionsForm(request.POST, result_grid=result_grid)
		if form.is_valid():
			text = form.cleaned_data['text']
			result_grid.instructions = text
			result_grid.save()
			return HttpResponseRedirect(reverse('submission_creation', kwargs={'dataset_id':dataset_id, 'grid_id': grid_id}))
	context = {
		"form": form,
		"result_grid": result_grid,
	}
	return render(request, "dataset/edit/instructions.html", context)
...
def publication_creation(request, id=None):
	...
	return render(request, "publication/creation.html", context)
