...
import chalearnlap.users.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='/static/images/default.jpg', null=True, upload_to=chalearnlap.users.models.partner_member_avatar_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField()),
                ('is_public', models.BooleanField(default=False)),
                ('evaluation_file', models.FileField(null=True, upload_to=chalearnlap.users.models.dataset_path)),
                ('gt_file', models.FileField(null=True, upload_to=chalearnlap.users.models.dataset_path)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(max_length=30, null=True)),
                ('bio', models.TextField(max_length=3000)),
                ('avatar', models.ImageField(null=True, upload_to=chalearnlap.users.models.user_avatar_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prediction_file', models.FileField(null=True, upload_to=chalearnlap.users.models.prediction_path)),
                ('ground_truth', models.FileField(null=True, upload_to=chalearnlap.users.models.gt_path)),
                ('output', models.FileField(null=True, upload_to=chalearnlap.users.models.output_path)),
                ('rank', models.IntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, null=True)),
                ('content', ckeditor.fields.RichTextField(null=True)),
                ('paper', models.FileField(null=True, upload_to=chalearnlap.users.models.paper_path)),
                ('result', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.result')),
                ('submission', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.submission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(null=True, upload_to=chalearnlap.users.models.partner_avatar_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, null=True)),
                ('file', models.FileField(null=True, upload_to=chalearnlap.users.models.data_path)),
