...
urlpatterns = [
    ...
    url(r'^dataset/(?P<id>\d+)/remove/(?P<submission_id>\d+)/submission$', views.dataset_remove_submission, name="dataset_remove_submission"),
    ...
    url(r'^dataset/(?P<dataset_id>\d+)/news/(?P<news_id>\d+)/edit/$', views.news_edit, name="dataset_news_edit"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<grid_id>\d+)/creation$', views.submission_creation, name="submission_creation"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<grid_id>\d+)/instructions/edit/$', views.submission_instructions_edit, name="submission_instructions_edit"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<sub_id>\d+)/score/$', views.submission_score, name="submission_score"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<sub_id>\d+)/resume/$', views.result_user_submission, name="submission_resume"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<sub_id>\d+)/fact-sheet/creation/$', views.result_user_submission_edit, name="submission_fact_sheet_creation"),
    url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<sub_id>\d+)/fact-sheet/(?P<sheet_id>\d+)/edit/$', views.result_user_submission_edit, name="submission_fact_sheet_edit"),
    # url(r'^dataset/(?P<dataset_id>\d+)/submission/(?P<sub_id>\d+)/(?P<grid_id>\d+)/score/$', views.submission_score, name="submission_score"),
    ...
    url(r'^dataset/(?P<dataset_id>\d+)/results/(?P<grid_id>\d+)/export-participants-csv/$', views.export_participants_csv, name="export_participants_csv"),
    url(r'^dataset/(?P<dataset_id>\d+)/results/(?P<grid_id>\d+)/export-submitted-xls/$', views.export_participants_xls, name="export_participants_xls"),
    url(r'^dataset/(?P<dataset_id>\d+)/results/(?P<grid_id>\d+)/export-submitted-xlsx/$', views.export_participants_xlsx, name="export_participants_xlsx"),
    ...
    # Partner urls
    url(r'^sponsors/list/$', views.partner_list, name="partners_list"),
    url(r'^sponsors/creation/$', views.partner_creation, name="general_partner_creation"),
    url(r'^event/(?P<id>\d+)/sponsors/creation/$', views.partner_creation, name="partner_creation"),
    url(r'^event/(?P<id>\d+)/sponsors/select/$', views.partner_select, name="partner_select"),
    # Event urls
    ...
    url(r'^event/(?P<id>\d+)/edit//$', views.event_edit, name="event_edit"),
    ...
    url(r'^challenge/(?P<id>\d+)/edit/people$', views.challenge_edit_members, name="challenge_edit_members"),
    ...
    url(r'^challenge/(?P<id>\d+)/people/(?P<role_id>\d+)/$', views.challenge_members, name="challenge_members"),
    ...
    url(r'^challenge/(?P<id>\d+)/sponsors/(?P<sponsor_id>\d+)/remove$', views.event_partner_remove, name="challenge_partner_remove"),
    url(r'^challenge/(?P<id>\d+)/schedule/$', views.challenge_schedule, name="challenge_schedule"),
    url(r'^challenge/(?P<id>\d+)/schedule/(?P<program_id>\d+)/remove$', views.event_schedule_remove, name="challenge_schedule_remove"),
    url(r'^challenge/(?P<id>\d+)/schedule/(?P<schedule_id>\d+)/edit/$', views.schedule_edit, name="challenge_schedule_edit"),
    url(r'^challenge/(?P<id>\d+)/schedule/creation$', views.schedule_creation, name="challenge_schedule_creation"),
    ...
    url(r'^challenge/(?P<id>\d+)/track/(?P<track_id>\d+)/result/(?P<result_id>\d+)/fact-sheet/(?P<sheet_id>\d+)/edit/$', views.fact_sheet_creation, name="fact_sheet_edit"),
    url(r'^challenge/(?P<id>\d+)/track/(?P<track_id>\d+)/result/(?P<result_id>\d+)/fact-sheet/creation/$', views.fact_sheet_creation, name="fact_sheet_creation"),
    url(r'^challenge/(?P<id>\d+)/track/(?P<track_id>\d+)/result/fact-sheet/(?P<f_sheet_id>\d+)/$', views.result_fact_sheet, name="result_fact_sheet"),
    ...
    url(r'^challenge/(?P<id>\d+)/associated-events/creation$', views.event_relation_creation, name="challenge_relation_creation"),
    url(r'^challenge/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/remove$', views.event_relation_remove, name="challenge_relation_remove"),
    # url(r'^challenge/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/edit$', views.event_relation_edit, name="challenge_relation_edit"),
    url(r'^challenge/(?P<id>\d+)/people/select/$', views.profile_select, name="challenge_profile_select"),
    url(r'^challenge/(?P<id>\d+)/people/(?P<member_id>\d+)/remove$', views.event_member_remove, name="challenge_member_remove"),
    url(r'^challenge/(?P<id>\d+)/people/(?P<member_id>\d+)/edit/$', views.profile_edit, name="challenge_profile_edit"),
    # url(r'^challenge/(?P<id>\d+)/people/creation/$', views.profile_creation, name="challenge_profile_creation"),
    url(r'^challenge/(?P<id>\d+)/news/creation/$', views.news_creation, name="challenge_news_creation"),
    url(r'^challenge/(?P<id>\d+)/news/(?P<news_id>\d+)/edit/$', views.news_edit, name="challenge_news_edit"),
    url(r'^challenge/(?P<id>\d+)/news/(?P<news_id>\d+)/remove$', views.event_news_remove, name="challenge_news_remove"),
    # Workshop urls
    ...
    url(r'^workshop/(?P<id>\d+)/program/(?P<program_id>\d+)/remove$', views.workshop_program_remove, name="workshop_program_remove"),
    url(r'^workshop/(?P<id>\d+)/program/creation/$', views.program_creation, name="program_creation"),
    url(r'^workshop/(?P<id>\d+)/program/(?P<program_id>\d+)/edit/$', views.schedule_edit, name="program_edit"),
    url(r'^workshop/(?P<id>\d+)/schedule/$', views.workshop_schedule, name="workshop_schedule"),
    url(r'^workshop/(?P<id>\d+)/schedule/(?P<program_id>\d+)/remove$', views.event_schedule_remove, name="workshop_schedule_remove"),
    url(r'^workshop/(?P<id>\d+)/schedule/(?P<schedule_id>\d+)/edit/$', views.schedule_edit, name="workshop_schedule_edit"),
    url(r'^workshop/(?P<id>\d+)/schedule/creation$', views.schedule_creation, name="workshop_schedule_creation"),
    url(r'^workshop/(?P<id>\d+)/associated-events/$', views.workshop_associated_events, name="workshop_associated_events"),
    url(r'^workshop/(?P<id>\d+)/people/(?P<role_id>\d+)/$', views.workshop_members, name="workshop_members"),
    ...
    url(r'^workshop/(?P<id>\d+)/sponsors/(?P<sponsor_id>\d+)/remove$', views.event_partner_remove, name="workshop_partner_remove"),
    url(r'^workshop/(?P<id>\d+)/associated-events/creation$', views.event_relation_creation, name="workshop_relation_creation"),
    url(r'^workshop/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/remove$', views.event_relation_remove, name="workshop_relation_remove"),
    # url(r'^workshop/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/edit$', views.event_relation_edit, name="workshop_relation_edit"),
    # url(r'^workshop/(?P<id>\d+)/people/creation$', views.speaker_creation, name="speaker_creation"),
    url(r'^workshop/(?P<id>\d+)/people/select$', views.profile_select, name="workshop_profile_select"),
    url(r'^workshop/(?P<id>\d+)/people/(?P<member_id>\d+)/remove$', views.event_member_remove, name="workshop_member_remove"),
    url(r'^workshop/(?P<id>\d+)/people/(?P<member_id>\d+)/edit/$', views.profile_edit, name="workshop_profile_edit"),
    url(r'^workshop/(?P<id>\d+)/news/creation/$', views.news_creation, name="workshop_news_creation"),
    url(r'^workshop/(?P<id>\d+)/news/(?P<news_id>\d+)/edit/$', views.news_edit, name="workshop_news_edit"),
    url(r'^workshop/(?P<id>\d+)/news/(?P<news_id>\d+)/remove$', views.event_news_remove, name="workshop_news_remove"),
    # Special issues urls
    ...
    url(r'^special-issue/(?P<id>\d+)/people/(?P<role_id>\d+)/$', views.special_issue_members, name="special_issue_members"),
    ...
    url(r'^special-issue/(?P<id>\d+)/schedule/(?P<program_id>\d+)/remove$', views.event_schedule_remove, name="special_issue_schedule_remove"),
    url(r'^special-issue/(?P<id>\d+)/schedule/(?P<schedule_id>\d+)/edit/$', views.schedule_edit, name="special_issue_schedule_edit"),
    url(r'^special-issue/(?P<id>\d+)/schedule/creation$', views.schedule_creation, name="special_issue_schedule_creation"),
    ...
    url(r'^special-issue/(?P<id>\d+)/associated-events/creation$', views.event_relation_creation, name="special_issue_relation_creation"),
    url(r'^special-issue/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/remove$', views.event_relation_remove, name="special_issue_relation_remove"),
    # url(r'^special-issue/(?P<id>\d+)/associated-events/(?P<relation_id>\d+)/edit$', views.event_relation_edit, name="special_issue_relation_edit"),
    url(r'^special-issue/(?P<id>\d+)/people/select/$', views.profile_select, name="special_issue_profile_select"),
    url(r'^special-issue/(?P<id>\d+)/people/(?P<member_id>\d+)/remove$', views.event_member_remove, name="special_issue_member_remove"),
    url(r'^special-issue/(?P<id>\d+)/people/(?P<member_id>\d+)/edit/$', views.profile_edit, name="special_issue_profile_edit"),
    url(r'^special-issue/(?P<id>\d+)/news/creation/$', views.news_creation, name="special_issue_news_creation"),
    url(r'^special-issue/(?P<id>\d+)/news/(?P<news_id>\d+)/edit/$', views.news_edit, name="special_issue_news_edit"),
    url(r'^special-issue/(?P<id>\d+)/news/(?P<news_id>\d+)/remove$', views.event_news_remove, name="special_issue_news_remove"),
    # Role urls
